    ...
    async def test_get_income_detail(self, client: AsyncClient, test_password: str):
        ...
        create_resp = await client.post(
            ...
            json={
                "account_id": acc_id,
                "amount": 5000,
                "description": "Detail test income",
        ...
        resp = await client.get(
            f"/api/v1/incomes/{income_id}", headers={"Authorization": f"Bearer {token}"}
        )
        assert resp.status_code == 200
...
class TestIncomeSources:
    ...
    async def test_list_sources(self, client: AsyncClient, test_password: str):
        ...
        resp = await client.get(
            "/api/v1/incomes/sources", headers={"Authorization": f"Bearer {token}"}
        )
        assert resp.status_code == 200
...
class TestIncomeSchedule:
    ...
    async def test_create_schedule(self, client: AsyncClient, test_password: str):
        ...
        resp = await client.post(
            "/api/v1/incomes/schedule",
            headers={"Authorization": f"Bearer {token}"},
            json={
                "description": "Freelance payment expected",
                "amount": 25000,
                "account_id": acc_id,
    ...
    async def test_list_schedule(self, client: AsyncClient, test_password: str):
        ...
        await client.post(
            ...
            headers={"Authorization": f"Bearer {token}"},
            json={
                "description": "Schedule list test",
                "amount": 10000,
                "account_id": acc_id,
        ...
        resp = await client.get(
            "/api/v1/incomes/schedule", headers={"Authorization": f"Bearer {token}"}
        )
        assert resp.status_code == 200
        assert resp.json()["total"] >= 1
...
class TestIncomeAnalytics:
    ...
    async def test_summary(self, client: AsyncClient, test_password: str):
        ...
        await client.post(
            ...
            json={
                "account_id": acc_id,
                "amount": 85000,
                "description": "Summary test salary",
                "effective_date": "2026-07-01",
                "income_type": "salary",
            },
        )
        ...
        resp = await client.get(
            "/api/v1/incomes/summary?date_from=2026-01-01&date_to=2026-12-31",
            headers={"Authorization": f"Bearer {token}"},
        )
        assert resp.status_code == 200
        data = resp.json()
    ...
    async def test_trends(self, client: AsyncClient, test_password: str):
        ...
        await client.post(
            ...
            json={
                "account_id": acc_id,
                "amount": 85000,
                "description": "Trends test",
                "effective_date": "2026-07-01",
            },
        )

        resp = await client.get(
            "/api/v1/incomes/trends?months=6", headers={"Authorization": f"Bearer {token}"}
        )
        assert resp.status_code == 200
    ...
    async def test_forecast(self, client: AsyncClient, test_password: str):
        ...
        resp = await client.get(
            "/api/v1/incomes/forecast", headers={"Authorization": f"Bearer {token}"}
        )
        assert resp.status_code == 200
    ...
    async def test_by_source(self, client: AsyncClient, test_password: str):
        ...
        await client.post(
            ...
            json={
                "account_id": acc_id,
                "amount": 85000,
                "description": "By source test",
                "effective_date": "2026-07-01",
            },
        )

        resp = await client.get(
            "/api/v1/incomes/by-source?date_from=2026-01-01&date_to=2026-12-31",
            headers={"Authorization": f"Bearer {token}"},
        )
        assert resp.status_code == 200
    ...
    async def test_monthly_breakdown(self, client: AsyncClient, test_password: str):
        ...
        await client.post(
            ...
            json={
                "account_id": acc_id,
                "amount": 85000,
                "description": "Monthly breakdown test",
                "effective_date": "2026-07-01",
            },
        )

        resp = await client.get(
            "/api/v1/incomes/monthly/2026/7", headers={"Authorization": f"Bearer {token}"}
        )
        assert resp.status_code == 200
    ...
    async def test_recurring_candidates(self, client: AsyncClient, test_password: str):
        ...
        await client.post(
            ...
            json={
                "account_id": acc_id,
                "amount": 85000,
                "description": "Recurring candidates test",
                "effective_date": "2026-07-01",
            },
        )

        resp = await client.get(
            "/api/v1/incomes/recurring-candidates", headers={"Authorization": f"Bearer {token}"}
        )
        assert resp.status_code == 200
