    ...
    async def execute(
        ...
        *,
        ...
        return {
            ...
            "source_transaction": {
                "id": str(tx1.id),
                "account_id": str(tx1.account_id),
                "amount": str(tx1.amount),
                "type": tx1.transaction_type,
            },
            "destination_transaction": {
                "id": str(tx2.id),
                "account_id": str(tx2.account_id),
            ...
            "created_at": tx1.created_at.isoformat() if tx1.created_at else None,
        }
