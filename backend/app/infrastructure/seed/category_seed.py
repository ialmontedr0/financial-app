...
SYSTEM_CATEGORIES: list[dict] = [
        ...
        "subcategories": [
            {
                "name": "Supermercado",
                "icon": "🛒",
                "keywords": "supermercado, colmado, mercado, walmart, price smart, jumbo, la sirena",
            },
            ...
            {"name": "Delivery", "icon": "🛵", "keywords": "delivery, ubereats, pedidosya, rappi"},
            {
                "name": "Comida Rapida",
                "icon": "🍔",
                "keywords": "mcdonalds, burger king, kfc, popeyes, wendys",
            },
        ...
        "subcategories": [
            {
                "name": "Gasolina",
                "icon": "⛽",
                "keywords": "gasolina, gas, fuel, shell, texaco, citgo",
            },
            ...
            {"name": "Peaje", "icon": "🚧", "keywords": "peaje, toll"},
            {
                ...
                "icon": "🚌",
                "keywords": "metro, guagua, bus, caribe tours, metrobus",
            },
            {"name": "Taxis/Uber", "icon": "🚕", "keywords": "uber, taxi, didi, indriver"},
            {
                "name": "Mantenimiento Vehiculo",
                "icon": "🔧",
                "keywords": "mecanico, taller, llantas, aceite, mantenimiento",
            },
        ],
    },
    {
        ...
        "subcategories": [
            {"name": "Alquiler", "icon": "🏘️", "keywords": "alquiler, rent"},
            {
                "name": "Hipoteca",
                "icon": "🏦",
                "keywords": "hipoteca, mortgage, prestamo hipotecario",
            },
            {
                "name": "Reparaciones",
                "icon": "🔨",
                "keywords": "reparacion, plomeria, electricidad, pintura",
            },
            {
                "name": "Decoracion",
                "icon": "🎨",
                "keywords": "decoracion, muebles, decoracion del hogar",
            },
            {
                "name": "Seguro del Hogar",
                "icon": "🛡️",
                "keywords": "seguro del hogar, seguro de vivienda",
            },
    ...
    },
    {
        ...
        "subcategories": [
            ...
            {"name": "Internet", "icon": "🌐", "keywords": "internet, altice, claro, vite"},
            {
                "name": "Telefono",
                "icon": "📱",
                "keywords": "telefono, claro, altice, Movistar, pospago",
            },
        ...
        "subcategories": [
            {
                "name": "Medicinas",
                "icon": "💊",
                "keywords": "medicina, farmacia, droga, medicamento, siman",
            },
            {
                "name": "Doctores",
                "icon": "👨‍⚕️",
                "keywords": "doctor, medico, consulta, especialista",
            },
            {
                "name": "Seguro Medico",
                "icon": "🏥",
                "keywords": "seguro medico, health insurance, ssn",
            },
        ...
        "subcategories": [
            {
                "name": "Universidad",
                "icon": "🎓",
                "keywords": "universidad, UP, UASD, UNA, INTEC, UCSD",
            },
            {"name": "Colegio", "icon": "🏫", "keywords": "colegio, escuela, school"},
            {
                "name": "Cursos",
                "icon": "📝",
                "keywords": "curso, capacitacion, training, udemy, coursera",
            },
            {
                "name": "Libros",
                "icon": "📖",
                "keywords": "libro, libro electronico, kindle, amazon books",
            },
            {
                "name": "Materiales",
                "icon": "✏️",
                "keywords": "material, papeleria, utiles, cuaderno",
            },
    ...
    },
    {
        ...
        "subcategories": [
            ...
            {"name": "Conciertos", "icon": "🎵", "keywords": "concierto, musica, evento"},
            {
                "name": "Streaming",
                "icon": "📺",
                "keywords": "netflix, disney+, hbo, amazon prime, spotify, apple music",
            },
            {
                "name": "Videojuegos",
                "icon": "🎮",
                "keywords": "videojuego, steam, playstation, xbox, nintendo",
            },
            {"name": "Hobbies", "icon": "🎨", "keywords": "hobby, pasatiempo, coleccion"},
            {
                "name": "Deportes",
                "icon": "⚽",
                "keywords": "deporte, gimnasio deportivo, cancha, membership",
            },
        ],
    },
    {
        ...
        "subcategories": [
            {"name": "Peluqueria", "icon": "✂️", "keywords": "peluqueria, barbero, salon, haircut"},
            {
                "name": "Gimnasio",
                "icon": "🏋️",
                "keywords": "gimnasio, gym, fitness, crossfit, membership",
            },
            {
                "name": "Cosmeticos",
                "icon": "💄",
                "keywords": "cosmetico, maquillaje, perfume, skincare",
            },
    ...
    },
    {
        ...
        "subcategories": [
            {"name": "Veterinario", "icon": "🩺", "keywords": "veterinario, vet, animal doctor"},
            {
                "name": "Alimentacion",
                "icon": "🦴",
                "keywords": "alimentacion mascota, pet food, dog Chow, whiskas",
            },
            {
                "name": "Accesorios",
                "icon": "🦮",
                "keywords": "accesorio mascota, collar, correa, cama",
            },
            {
                "name": "Peluqueria Mascota",
                "icon": "🐕",
                "keywords": "peluqueria mascota, pet grooming",
            },
        ],
    },
    {
        ...
        "subcategories": [
            {
                "name": "Vuelos",
                "icon": "🛫",
                "keywords": "vuelo, avion, airline, Copa, JetBlue, Spirit, Latam",
            },
            {
                "name": "Hoteles",
                "icon": "🏨",
                "keywords": "hotel, reserva, booking, airbnb, hostal",
            },
            {
                "name": "Alquiler de Auto",
                "icon": "🚙",
                "keywords": "alquiler auto, rent a car, hertz, budget",
            },
        ...
        "subcategories": [
            {
                "name": "Seguro Auto",
                "icon": "🚗",
                "keywords": "seguro auto, auto insurance, rayos, colision",
            },
            ...
            {"name": "Seguro Salud", "icon": "🏥", "keywords": "seguro salud, health insurance"},
            {
                "name": "Seguro Hogar",
                "icon": "🏠",
                "keywords": "seguro hogar, homeowners insurance",
            },
        ...
        "subcategories": [
            {
                "name": "Pago de Deuda",
                "icon": "💸",
                "keywords": "pago deuda, debt payment, loan payment",
            },
        ...
        "subcategories": [
            {
                "name": "Streaming",
                "icon": "📺",
                "keywords": "netflix, disney, hbo, hulu, youtube premium, twitch",
            },
            {
                "name": "Software",
                "icon": "💻",
                "keywords": "software, saas, adobe, microsoft 365, notion, canva",
            },
        ...
        "subcategories": [
            {
                "name": "Transferencias",
                "icon": "💸",
                "keywords": "comision transferencia, transfer fee",
            },
            {
                "name": "Mantenimiento",
                "icon": "🔧",
                "keywords": "mantenimiento cuenta, account maintenance fee",
            },
            {"name": "ATM", "icon": "🏧", "keywords": "atm, cajero, retiro, withdrawal fee"},
            {
                "name": "Overdraft",
                "icon": "⚠️",
                "keywords": "overdraft, sobregiro, fondo insuficiente",
            },
        ],
    },
    {
        ...
        "subcategories": [
            {
                "name": "Regalos",
                "icon": "🎁",
                "keywords": "regalo, gift, birthday, cumpleanos, navidad",
            },
    ...
    },
    {
        ...
        "subcategories": [
            {"name": "Oficina", "icon": "🏢", "keywords": "oficina, office, coworking"},
            {
                "name": "Equipos",
                "icon": "💻",
                "keywords": "equipo, computadora, laptop, monitor, impresora",
            },
            {
                "name": "Software",
                "icon": "💿",
                "keywords": "software, licencia, subscription business",
            },
            {
                "name": "Marketing",
                "icon": "📢",
                "keywords": "marketing, publicidad, ads, facebook ads",
            },
            {"name": "Legal", "icon": "⚖️", "keywords": "legal, abogado, lawyer, notario"},
            {
                "name": "Contable",
                "icon": "📊",
                "keywords": "contable, contador, accounting, bookkeeping",
            },
        ],
    },
    {
        ...
        "subcategories": [
            {
                ...
                "icon": "🚨",
                "keywords": "reparacion urgente, emergencia, plumber urgent",
            },
        ...
        "subcategories": [
            {
                "name": "Salario Base",
                "icon": "💵",
                "keywords": "salario base, base salary, sueldo base",
            },
            {"name": "Horas Extra", "icon": "⏰", "keywords": "horas extra, overtime"},
            {
                "name": "Bonificaciones",
                "icon": "🎉",
                "keywords": "bono, bonus, bonificacion, utilidades",
            },
        ],
    },
    {
    ...
    },
    {
        ...
        "subcategories": [
            ...
            {
                "name": "Ganancias de Capital",
                "icon": "📊",
                "keywords": "capital gains, ganancia, profit",
            },
        ],
    },
    {
        ...
        "subcategories": [
            {"name": "Reembolsos", "icon": "↩️", "keywords": "reembolso, refund, devolucion"},
            {
                ...
                "icon": "🏷️",
                "keywords": "venta, selling, olx, marketplace",
            },
            {
                "name": "Alquileres Cobrados",
                "icon": "🏘️",
                "keywords": "alquiler cobrado, rental income",
            },
        ],
    },
    {
        ...
        "subcategories": [
            {
                ...
                "icon": "🔄",
                "keywords": "transferencia interna, internal transfer",
            },
        ...
        "subcategories": [
            {
                ...
                "icon": "🔧",
                "keywords": "ajuste saldo, balance adjustment",
            },
...
async def seed_system_categories(session: AsyncSession) -> None:
    ...
    count_stmt = select(func.count(CategoryModel.id)).where(CategoryModel.is_system.is_(True))
